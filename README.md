...
> You can download the data directory generated by these first 3 stages
> [here](https://github.com/atomicul/veridion/releases/download/submission/data.zip)
...
> You can download the generated cluster_report.txt
> [here](https://github.com/atomicul/veridion/releases/download/submission/cluster_report.txt)

### Stage 5: Visualize (`5-visualize-clusters.py`)

Just a web page to view the results.

> It is sufficient to download the `data/` directory and `cluster_report.txt`
> that are linked above to run the visualizer
